/********************************************************************************************
NAME: [dbo].[vw_Sum_Total_Loan_Year]
PURPOSE: Create the view [dbo].[vw_Sum_Total_Loan_Year]
SUPPORT: Jose Santos
	  
MODIFICATION LOG:
Ver   Date        Author    Description
----  ----------  -------   -----------------------------------------------------------------
1.0   12/01/2019  Jose Santos  1. Creating New View vw_Sum_Total_Loan_Year
RUNTIME: 
1 min
NOTES: 
LICENSE: 
